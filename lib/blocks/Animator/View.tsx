...
import { AnimatorComponentProps, ViewAnimations } from './types'
import { useAnimated } from './useAnimated'
import { BaseLayoutProps, BaseLayout } from '../BaseLayout'
import { Omit } from '../utils/omit'
import { createInterpolatedStyles, viewAnimationList } from './animationList'

export type ViewAnimatorProps = {
  /**
  ...
  Omit<BaseLayoutProps, 'UnderlyingView'>
 ...
 * View component.
 */
export const ViewAnimator: React.FC<ViewAnimatorProps> = ({
  /** ViewAnimatorProps  */
  visible = true,
  config: _config,
  animation,
  ...
  const animationStyle = createInterpolatedStyles({
    ...
    nonTransformAnimationList: viewAnimationList,
  })
